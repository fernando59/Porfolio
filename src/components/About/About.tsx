      ...
      <main className="h-max lg:h-screen mx-auto container dark:text-white w-full py-20 ">
        ...
        <div className="flex flex-col-reverse w-full justify-between  lg:justify-between  lg:flex-row ">
          ...
          <div className="w-full py-20">
            ...
            <p className="w-full  lg:w-3/6 tracking-widest leading-6 py-10">Software developer with a solid two-year experience in Full stack development. My main focus is on using cutting-edge
              technologies like React, Flutter, Node JS and Net Core to create robust and efficient solutions.</p>
